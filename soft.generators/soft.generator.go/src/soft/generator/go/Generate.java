...
public class Generate extends Generator {
     ...
     */
    public static final String GENERATOR_NAME = "soft.generator.go";
    ...
    @picocli.CommandLine.Command(name = "soft.generator.go")
    private static class Command extends Generator.Command {
